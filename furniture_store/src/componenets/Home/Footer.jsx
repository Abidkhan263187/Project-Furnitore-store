  ...
  return (
    <div className='abid-footer-container'>
      ...
      <div className='footer-one-abid'>
        ...
        <div id='fst-abid-clock'>
          <div id='abid-clock'><img style={{ marginTop: "0px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-7azER2rBWaqPcK0v_VgMrxXdcbEfPddJYw&usqp=CAU" alt="" /></div>
          <div id="detail-inside">
            <p>Support</p>
            <p>Documentation</p>
            <p>All collection</p>
